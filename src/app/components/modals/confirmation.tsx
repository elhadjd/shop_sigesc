...
export default function Confirmation({closeModal,title,description,confirm}:{closeModal:VoidFunction,title: string,description: string,confirm: any}) {
    ...
    <DrawerModal >
        <div className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
            ...
            <div className="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                <button type="button" className="inline-flex w-full justify-center items-center rounded-md bg-red-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-red-500 sm:ml-3 sm:w-auto"
                    onClick={()=>{confirm(),setLoad(true)}}>
                    Confirm
                    {
